...
@EntityScan(basePackages = {"brewbuddy.model"})
@EnableJpaRepositories(basePackages = {"brewbuddy.service"})
//@ComponentScan(basePackages = {"brewbuddy.service", "brewbuddy.repository"})
public class ServiceApplication  {
	...
	public KieContainer kieContainer() {
		...
		KieContainer kContainer = ks
				.newKieContainer(ks.newReleaseId("brewbuddy", "kjar", "0.0.1-SNAPSHOT"));
